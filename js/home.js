...
function displayHomeWeather(weather) {
...
function displayHomeWeatherError(city) {
  const weatherIconElement =
    document.getElementById(
      "homeWeatherIcon"
    );
...
function getUpcomingTripDay() {
  // Month is 0-based, so 8 means September
  const tripStartDate =
    new Date(2026, 8, 10);
...
function getHomeText() {
  ...
  return {
    en: {
      ...
      locationDesc:
        `Day ${currentDay.day} / ${tripData.totalDays}`,
      ...
      dayLabel:
        `Day ${currentDay.day} · ${currentDay.displayDate}`,
    ...
    zh: {
      ...
      locationDesc:
        `第 ${currentDay.day} / ${tripData.totalDays} 天`,
      ...
      dayLabel:
        `第 ${currentDay.day} 天 · ${currentDay.displayDate}`,
...
function renderHomePage(container) {
  ...
  updateCountdown();
  updateHomeWeather(currentDay);

  document
    .getElementById("openItineraryBtn")
    .addEventListener(
      "click",
      () => {
  ...
  document
    .getElementById("viewFullItineraryBtn")
    .addEventListener(
      "click",
      () => {
        renderLayout("itinerary");
